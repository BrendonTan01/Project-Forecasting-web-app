  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {recommendations.map((rec) => {
        const isSelected = selectedSkill === rec.skill;
        ...
        return (
          ...
          >
            <button
              type="button"
              onClick={() => setSelectedSkill(isSelected ? null : rec.skill)}
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td className="pt-2 text-right tabular-nums text-xs font-semibold text-zinc-800">
                          {(() => {
                            const total = rec.demand_sources.reduce(
